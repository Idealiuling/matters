...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/matters?useUnicode=true&useSSl=fals@characterEncoding=utf-8&serverTimezone=GMT%2B8");
        ...
        if (scanner("是否继承基类").equalsIgnoreCase("y")){
            strategy.setSuperEntityClass("com.customer.matters.entity.BaseEntity");
      ...
      strategy.setEntityLombokModel(true);
       ...
       tableFill.add(modifiedTime);
       tableFill.add(createAccountId);
       tableFill.add(modifiedAccountId);
